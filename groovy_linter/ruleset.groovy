// Ruleset taken from https://github.com/AbletonDevTools/groovylint
...
ruleset {
    ...
    ruleset('rulesets/formatting.xml') {
        ...
        Indentation(spacesPerIndentLevel: 4, enabled: true)
    ...
    ruleset('rulesets/size.xml') {
        ...
        CyclomaticComplexity(maxClassComplexity: 50, maxMethodComplexity: 50)
